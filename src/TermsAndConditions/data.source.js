    ...
    children: [
      ...
      },
      {
        ...
        children: (
          <span>
            <p>
              It has come to our attention that there are some dishonest people
              out there that are trying to ruin this service by charging people
              to simply use this website. This is not permitted and goes against
              everything we have worked so hard to create with this website.
            </p>
            <p>
              This website is 100% free to use and we work hard everyday to keep
              it that way. That is not changing.
            </p>
            <p>
              You may see us run advertisements on the website from time to
              time. This is simply to cover the costs of running our servers,
              staff and other business related operations. Everything we do, we
              do with the community in mind.
            </p>
            <p>Please:</p>
            <p>- Continue to have fun using this site</p>
            <p>- Continue to share it with your friends and communities</p>
            <p>
              - Let us know all the cool ideas you think we should add to
              continually make it better for everyone
            </p>
            <p>
              - Let us know if you see someone breaking these simple rules. We
              will track them down and stop them
            </p>
          </span>
        ),
            ...
            <b>
              <span>
                <p>
                  ...
                  for the use of Lines Police CAD's Website, located at
        ...
        children: (
          <span>
            <p>
              ...
              conditions. Do not continue to use Lines Police Server if you do
            ...
            <p>Cookies</p>
            <p>
              We employ the use of cookies. By accessing Lines Police CAD, you
              agreed to use cookies in agreement with the Lines Police CAD's
              Privacy Policy.
            </p>
            <p>
            ...
            <p>License</p>
            <p>
              Unless otherwise stated, Lines Police CAD and/or its licensors own
              the intellectual property rights for all material on Lines Police
              CAD. All intellectual property rights are reserved. You may access
              this from Lines Police CAD for your own personal use subjected to
              restrictions set in these terms and conditions.
            </p>
            <p>You must not:</p>
            <p> Republish material from Lines Police CAD</p>
            <p> Sell, rent or sub-license material from Lines Police CAD</p>
            <p> Reproduce, duplicate or copy material from Lines Police CAD</p>
            <p> Redistribute content from Lines Police CAD</p>
            <p>This Agreement shall begin on the date hereof.</p>
            <p>
              Parts of this website offer an opportunity for users to post and
              exchange opinions and information in certain areas of the website.
              Lines Police CAD does not filter, edit, publish or review Comments
              prior to their presence on the website. Comments do not reflect
              the views and opinions of Lines Police Server,its agents and/or
              ...
              applicable laws, Lines Police CAD shall not be liable for the
            ...
            <p>
              Lines Police CAD reserves the right to monitor all Comments and to
            ...
            <p>
              You hereby grant Lines Police CAD a non-exclusive license to use,
            ...
            <p>
              ...
              Lines Police CAD; and (d) the link is in the context of general
            ...
            <p>
              ...
              by sending an e-mail to Lines Police CAD. Please include your
            ...
            <p>
              No use of Lines Police CAD's logo or other artwork will be allowed
